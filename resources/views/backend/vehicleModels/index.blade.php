...
@section('content')
    <div class="page-wrapper">
        <div class="content">
            <x-breadcrumb title="Vehicle Model List" sub-title="Manage vehicle model" permission="vehicle-model-create" button="Add vehicle model"
            button-route="admin.vehicle-models.create" />
